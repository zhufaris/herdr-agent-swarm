...
O-10 removes a separate reconciliation false failure. Historical Pane ownership
remains visible to discovery and explicit attachment, but terminal or provisioning
bindings no longer consume live runtime observations. The eligibility decision is
