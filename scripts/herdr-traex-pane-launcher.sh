...
executable=${values[0]}
args=("${values[@]:1}")
# Preserve TraeX's real process identity. The process-fenced reporter owns the
# internal Codex-compatible Herdr authority; disguising argv[0] as codex makes
# Herdr's terminal detector override hook-driven lifecycle reports.
