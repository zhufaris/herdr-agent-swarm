...
const buildId = calculateBuildId({
  serviceId: "herdr-lark-bridge", version: packageJson.version, nodeVersion: process.versions.node, nodeModulesAbi: process.versions.modules ?? "unknown",
...
const identity = { serviceId: "herdr-lark-bridge", version: packageJson.version, buildId, gitCommit };
