...
export class PrimaryToolBroker {
  ...
  constructor(private readonly identity: PrimaryIdentity, private readonly messaging: PrimaryToolMessagingPort, private readonly workerCards?: Pick<WorkerCardDisplayWorkflow, "show">) { this.actor = { kind: "thread-primary", projectId: identity.projectId, bindingId: identity.bindingId, bindingGeneration: identity.bindingGeneration, parentPromptId: identity.parentPromptId }; }
