...
import type { Binding, ExternalTurnAdoption, OutboundReply, OutboundWorkClass, PromptJob, PromptObservationState, PromptState, TranscriptTurnClaimOutcome } from "../../domain/types.js";
