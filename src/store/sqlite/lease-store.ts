...
const FENCED_TABLES = [
  "bindings", "binding_thread_aliases", "agent_instances", "worker_session_threads", "worker_thread_entry_requests", "workspace_leases", "instance_removal_plans", "instance_turns", "worker_turn_cards", "worker_turn_card_pages", "worker_main_views", "card_context_invalidations", "instance_operations", "instance_events", "primary_tool_capabilities", "worker_card_display_requests", "approval_requests", "approval_grants", "conversation_targets", "inbound_messages", "bridge_messages", "prompt_jobs", "outbound_replies",
  "outbox_lane_heads", "outbox_lane_quarantines", "delivery_recoveries", "answer_delivery_coverage", "answer_recovery_links", "answer_recovery_candidates", "lark_delivery_cooldowns",
  "project_selections", "card_interactions", "session_operations", "swarm_command_intents", "command_status_views", "natural_language_command_confirmations", "controller_interpretation_jobs", "controller_runtime", "pane_close_requests", "worker_pane_close_steps", "pane_control_operations", "turn_control_operations", "retired_pane_cleanup_operations", "binding_model_preferences", "audit_log", "lifecycle_events", "topic_views", "run_cards", "answer_pages", "answer_timeline_items", "answer_timeline_page_checkpoints"
] as const;
