...
const FENCED_TABLES = [
  ...
  "project_selections", "card_interactions", "session_operations", "swarm_command_intents", "natural_language_command_confirmations", "controller_interpretation_jobs", "controller_runtime", "pane_close_requests", "worker_pane_close_steps", "pane_control_operations", "turn_control_operations", "retired_pane_cleanup_operations", "binding_model_preferences", "audit_log", "lifecycle_events", "topic_views", "run_cards", "answer_pages"
] as const;
