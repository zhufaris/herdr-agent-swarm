...
function setup() {
  ...
  store.acceptInstanceTurnWithCard({ id: "turn-1", idempotencyKey: "lark:turn-1", actor: { kind: "human", userId: "u1" }, projectId: "p1", instanceId: worker.id, instanceGeneration: worker.generation, kind: "turn", text: "review", parentTurnId: null, sourceMessageId: "message-1", view, card: renderWorkerTurnCard(view) });
