...
export function createTestRouter(
  ...
  const messageRouting = new InboundMessageRoutingWorkflow({ config, stores: { routing: store, promptAcceptance: store }, lifecycleEvents: bus, outbound: writer, outboundWork, logger, scheduler, presentation: cardKitPrimaryPresentation, promptRun, provisioning, swarmCommands });
