...
export const SqliteBindingStore: StoreConstructor = class {
  constructor(path: string) {
    ...
    return Object.assign(kernel, {
      ...
      ...bindMethods(modules.outbox, ["enqueueOutboundReply", "getActiveAnswerPage", "isActiveBindingThreadAlias", "getLarkDeliveryCooldown", "getNextOutboundLaneHeadAttemptAt", "getPrompt", "listOutboundLaneHeads", "loadRunCard", "recoverEligibleDeadLetters", "recordBridgeMessage", "dismissSupersededAnswerStream", "loadWorkerTurnCard", "loadWorkerMainView", "listWorkerTurnCardPages"]),
